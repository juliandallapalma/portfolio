...
const SITE = {
  ...
  // Second line renders in italic
   ...
   aboutBody: `With five years in broadcast at SBS and two years delivering large-scale activations at Polite Playground, Julian brings the technical knowledge to build it right and the experience to deliver it big.`,
  ...
  work: [
    ...
    },
	{
      ...
      role:    "Senior Technical Operations",
      detail:  "Beachfront branded activation at Bondi Pavilion requiring additional engineering and environmental planning due to coastal wind conditions.",
    ...
    },
    {
      ...
      role:    "Senior Technical Operations",
      detail:  "Multiple premium branded pop-up experiences across Sydney locations featuring an integrated automated photo studio.",
    ...
    },
    {
      ...
      detail:  "Weekend activation at Bourke Street Mall featuring interactive games, branded photo opportunities, poster creation, and customized instant noodle samples.",
    ...
    },
    {
      featured: false,
      brand:   "Vaseline",
      event:   "Gluta-Hya Live Billboard Experience",
      role:    "Technical Operations",
    ...
    {
      featured: false,
      brand:   "Optus x Nothing Phone",
      event:   "Move, You Lose",
      role:    "Senior Technical Operations",
      detail:  "National experiential campaign promoting the launch of the Nothing Phone across five locations in NSW, VIC and QLD. The activation centred around an interactive sensor challenge to see who could \"do nothing\" for the longest time. Records reached over 2 hours!",
